...
class Reclamation
{
     ...
     * Add user
     *
     * @param \Allforkids\UserBundle\Entity\User $user
     *
     * @return Reclamation
     */
    public function addUser(\Allforkids\UserBundle\Entity\User $user)
    {
        $this->users[] = $user;
     ...
     * @param \Allforkids\UserBundle\Entity\User $user
     */
    public function removeUser(\Allforkids\UserBundle\Entity\User $user)
    {
     ...
     * @return Reclamation
     */
    public function setUser(\Allforkids\UserBundle\Entity\User $user = null)
    {
        $this->user = $user;
     ...
     * Get user
     *
     * @return \Allforkids\UserBundle\Entity\User
     */
